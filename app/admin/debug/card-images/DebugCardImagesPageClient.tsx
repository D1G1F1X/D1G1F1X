...
interface DebugCardImagesPageClientProps {
  initialCards: OracleCard[]
  initialBlobImages: BlobInfo[]
}

export function DebugCardImagesPageClient({ initialCards, initialBlobImages }: DebugCardImagesPageClientProps) {
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-6">
      <h1 className="text-3xl font-bold mb-6">Debug Card Images</h1>
