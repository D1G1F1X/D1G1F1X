            ...
            <div className="h-80 bg-gray-900/80 relative overflow-hidden">
              <div className="w-full h-full relative">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = `/placeholder.svg?height=400&width=800&text=${encodeURIComponent(post.title)}`
                  }}
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-sm overflow-hidden border border-gray-700/50 hover:border-primary-500/30 transition-all duration-300 group">
                <div className="h-40 bg-gray-900/80 relative overflow-hidden">
                  <div className="w-full h-full relative">
                    <img
                      src="/placeholder.svg?height=160&width=240&text=AI%20Business%20Growth"
                      alt="Leveraging AI for Business Growth"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent opacity-60"></div>
              ...
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-sm overflow-hidden border border-gray-700/50 hover:border-primary-500/30 transition-all duration-300 group">
                <div className="h-40 bg-gray-900/80 relative overflow-hidden">
                  <div className="w-full h-full relative">
                    <img
                      src="/placeholder.svg?height=160&width=240&text=Web%20Development%20Trends"
              ...
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-sm overflow-hidden border border-gray-700/50 hover:border-primary-500/30 transition-all duration-300 group">
                <div className="h-40 bg-gray-900/80 relative overflow-hidden">
                  <div className="w-full h-full relative">
                    <img
                      src="/placeholder.svg?height=160&width=240&text=Data-Driven%20Marketing"
                      alt="Data-Driven Marketing Strategies"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent opacity-60"></div>
