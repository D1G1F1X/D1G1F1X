      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg text-primary-400 font-semibold">
            Domain:{" "}
            <Link href="https://icemelt.app" target="_blank" rel="noopener noreferrer" className="hover:underline">
              icemelt.app
            </Link>
          </p>
          ...
          <div className="flex gap-4">
            <Link href="https://icemelt.app" target="_blank" rel="noopener noreferrer">
              <Button className="bg-primary-600 hover:bg-primary-700 text-white">
                Visit Live Site <ExternalLinkIcon className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link href="/portfolio">
