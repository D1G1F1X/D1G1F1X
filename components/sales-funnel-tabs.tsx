...
const CATEGORIES = {
  ...
  E: {
    ...
    items: [
      ...
      { code: 'E2', name: 'System transformation strategy', cost: 5000 },
...
export default function SalesFunnelTabs({ showHeader = true }: SalesFunnelTabsProps) {
                  ...
                  <div className="sticky top-24 p-6 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border border-teal-500/30">
                    ...
                    {selectedItems.length > 0 && (
                      <Button asChild size="lg" className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold">
                        <Link href="/diagnostic#intake-form">Get Started</Link>
                      </Button>
                    )}
                  </div>
