...
import {
  ...
  individualCardData as importedIndividualCardData,
...
const individualCardData: IndividualCardData = importedIndividualCardData
...
const NumoTutorialPage: React.FC = () => {
  ...
  const elementInfoDisplayRef = useRef<HTMLDivElement>(null)
  const displayedElementNameElRef = useRef<HTMLSpanElement>(null)
  const displayedElementDescriptionElRef = useRef<HTMLSpanElement>(null)
  ...
  const pages = useMemo(
    () => [
      ...
      { id: "lesson2", title: "Explore the Oracle Cards", icon: Library, category: "Foundations" },
...
`
  ...
  const drawDailyInsight = useCallback(() => {
    if (
      ...
      !isClient ||
      Object.keys(individualCardData).length === 0
    )
      return
  ...
  useEffect(() => {
    if (isClient) {
      goToPage("welcome")
      updateNumerologySystemUI("pythagorean")
    }
      ...
      <main className="flex-1 md:ml-72 p-4 sm:p-6 md:p-8 lg:p-10 mt-16 md:mt-0 overflow-y-auto">
        ...
        <AnimatePresence mode="wait">
          ...
          >
                ...
                <CardContent className="tutorial-content space-y-6">
                  ...
                  <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                    ...
                    <ul className="list-disc list-inside space-y-1.5 text-sm text-slate-400">
                      ...
                      <li>Exploration of the NUMO Oracle cards via the interactive Card Directory.</li>
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-4 text-slate-400 text-sm">
                    ...
                    <li>
                      ...
                      <a
                        href="https://facebook.com/numocards"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="tutorial-link"
                      >
            ...
            {currentPageId === "glossary" && (
              <Card className="tutorial-card">
                <CardHeader>
                  <CardTitle className="tutorial-title">Glossary of Terms</CardTitle>
                </CardHeader>
                <CardContent className="tutorial-content space-y-4">
                  <p>Key terms and concepts used throughout the NUMO Oracle system:</p>
                  <div className="grid gap-4">
                    <div className="p-3 bg-slate-800/50 rounded-md border border-slate-700">
                      <h4 className="font-medium text-purple-300 mb-1">Five Gifts of Danu</h4>
                      <p className="text-xs text-slate-400">
                        The five sacred treasures corresponding to the NUMO suits: Cauldron, Sword, Cord, Spear, and
                        Stone.
                      </p>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-md border border-slate-700">
                      <h4 className="font-medium text-purple-300 mb-1">Symmetrical Pairs</h4>
                      <p className="text-xs text-slate-400">
                        The foundational number pairs (0/1, 2/5, 3/8, 4/7, 6/9) that form the basis of the NUMO system.
                      </p>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-md border border-slate-700">
                      <h4 className="font-medium text-purple-300 mb-1">Chaldean Numerology</h4>
                      <p className="text-xs text-slate-400">
                        An ancient numerological system with unique letter values and compound number meanings.
                      </p>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-md border border-slate-700">
                      <h4 className="font-medium text-purple-300 mb-1">Pythagorean Numerology</h4>
                      <p className="text-xs text-slate-400">
                        A modern Western numerological system assigning values 1-9 to letters.
                      </p>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-md border border-slate-700">
                      <h4 className="font-medium text-purple-300 mb-1">Master Numbers</h4>
                      <p className="text-xs text-slate-400">
                        Special numbers (11, 22, 33) with amplified spiritual significance.
                      </p>
                    </div>
                  </div>
                </CardContent>
